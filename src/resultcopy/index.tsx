...
const ResultCopy = () => {
  return (
    <PageWrapper>
      ...
      <FlexWrapper marginTop={-0.8}>
        <CardWrapper width="70%">
          <Logos src={logo} />
          <CardTitle>Congratulation .. Suresh kumar</CardTitle>
          <Label>You are a Analyst</Label>
          <CardFooter>
            <CardText>
              Following are the recommended CloudKompass Certificate Program For
              You:
            </CardText>
            <Images src={log} />
          </CardFooter>
        ...
        <CardWrapper width="29.8%">
          <Title>Your Result Document For</Title>
          <Text>Aeronautical-Product Head</Text>
